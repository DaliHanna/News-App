...
public class QueryUtils {
    ...
    private static List<NewsArticle> extractFeatureFromJson(String newsArticleJSON)
    {
        ...
        try{
        JSONObject root = new JSONObject(newsArticleJSON.toString());
        ...
        for (int i = 0; i < news.length(); i++) {
            ...
            title = element.optString("webTitle");
            section = element.optString("sectionName");
            ...
            for (int j = 0; j < tags.length(); j++) {
                ...
                firstName = tagsElement.optString("firstName");
                lastName = tagsElement.optString("lastName");
                author = firstName + " " + lastName;
            }
            date = element.optString("webPublicationDate");
            webUrl = element.optString("webUrl");
            newsArticles.add(new NewsArticle(title, author, imageUrl, date, webUrl, section));
        }
